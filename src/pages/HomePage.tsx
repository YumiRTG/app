  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-[100svh] overflow-hidden flex flex-col justify-end">
        ...
        {/* Top HUD strip */}
        <div className="absolute top-24 left-0 right-0 z-10 container-dd flex items-center justify-between opacity-70">
        ...
        <div className="relative z-10 container-dd pb-16 md:pb-24 pt-32">
          <p className="eyebrow mb-6">Prehistoric strategy survival</p>

          <h1 className="display-xl text-white max-w-5xl">
            DINO
            <br />
        ...
        <div className="container-dd relative z-10 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={x.t} className="dd-panel p-5">
      ...
      <section className="section-band pb-24">
        <div className="container-dd">
          ...
          >
            <div
              className="absolute -right-20 -top-20 w-72 h-72 rounded-full opacity-40 blur-3xl pointer-events-none"
