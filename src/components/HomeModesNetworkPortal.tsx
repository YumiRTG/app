...
const FEATURES = [
  {
    ...
    slot: 'defense',
    label: 'TOWER DEFENSE',
    title: 'WEEKLY SKILL TEST',
    stat: 'RANKED WEEKLY',
    text: 'A fresh defense challenge every week. Everyone faces the same battlefield and rules — placement, timing and adaptation decide how high you climb.',
    hook: 'Build smarter. React faster. Take the ranking.',
    img: asset('promo/tower-defense-promo.jpg'),
    pos: 'center center',
    accent: '#e7b84b',
    to: '/modes/tower-defense',
    chips: ['Weekly challenge', 'Skill ranking', 'Primitive defenses'],
  },
  {
    key: 'campaign',
    slot: 'campaign',
