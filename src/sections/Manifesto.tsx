  ...
  return (
    ...
    >
      <div className="max-w-[1000px] mx-auto text-center">
        ...
        >
          A WORLD WHERE THE STRONGEST DO NOT SURVIVE — BUT THE MOST ADAPTABLE. IN DINO DOMINION YOU BUILD YOUR TRIBE, TAME POWERFUL CREATURES, AND LEAD YOUR PEOPLE THROUGH A LIVING PREHISTORIC WORLD FULL OF DANGER AND WONDER.
        </p>
      </div>
    </section>
  )
