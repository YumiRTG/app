...
export const DEV_SCREENSHOTS: DevShot[] = [
  ...
  },
  {
    ...
    caption: 'Hero screen',
    note: 'Levels, stars, gear and skills for every hero on the roster.',
    date: 'Current build',
    pos: 'center top',
  },
  {
    src: asset('env-loading-scene-6.png'),
    caption: 'Volcano region',
    note: 'One of the nine campaign regions, each with its own terrain and enemy mix.',
    date: 'Current build',
    pos: 'center 40%',
  },
  {
